  ...
  return (
    <section className="min-h-[11in] p-20">
      ...
      <div className="mt-16 max-w-2xl">
        {items.map((item, i) => (
          <div key={i} className="flex items-start justify-between gap-6 border-b border-[#e5e5e5] py-5">
            <div>
        ...
        <div className="flex items-baseline justify-between border-t-2 border-red pt-6">
